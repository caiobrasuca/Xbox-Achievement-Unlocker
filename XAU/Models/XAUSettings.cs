public class XAUSettings
{
    ...
    // Defaults true so existing settings files (missing this key) keep auto-update on.
    // The updater points at our own repo, so this only controls whether to check at all.
